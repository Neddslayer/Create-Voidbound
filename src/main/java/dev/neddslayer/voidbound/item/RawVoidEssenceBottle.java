...
public class RawVoidEssenceBottle extends Item implements ProjectileItem {
    public RawVoidEssenceBottle(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            RawVoidEssenceBottleProjectile bottleProjectile = new RawVoidEssenceBottleProjectile(level, player);
    ...
    public Projectile asProjectile(Level level, Position pos, ItemStack stack, Direction direction) {
        RawVoidEssenceBottleProjectile bottleProjectile = new RawVoidEssenceBottleProjectile(level, pos.x(), pos.y(), pos.z());
